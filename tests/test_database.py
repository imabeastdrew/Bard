...
class TestChapterOperations:
    ...
    def test_insert_and_get_chapter(self):
        ...
        chapter = Chapter(
            chapter_id=1, title="Test Chapter", audio_path="audio/test.mp3", duration_seconds=120.5
        )
...
class TestSentenceOperations:
    ...
    def test_insert_and_get_sentences(self):
        ...
        sentences = [
            Sentence(
                sentence_id=1, chapter_id=1, sequence=0, text="First.", start_time=0.0, end_time=1.0
            ),
            Sentence(
                sentence_id=2,
                chapter_id=1,
...
class TestAlignmentQueries:
    ...
    def test_find_sentence_at_time_exact(self):
        ...
        sentences = [
            Sentence(
                sentence_id=1, chapter_id=1, sequence=0, text="First.", start_time=0.0, end_time=2.0
            ),
            Sentence(
                sentence_id=2,
                chapter_id=1,
