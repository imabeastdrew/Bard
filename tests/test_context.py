...
from bard.database import init_db, insert_chapter, insert_sentences_batch, reset_db
...
def setup_test_db(tmp_path, monkeypatch):
    ...
    sentences = [
        Sentence(sentence_id=1, chapter_id=1, sequence=0, text="First sentence.", start_time=0.0, end_time=2.0),
        Sentence(sentence_id=2, chapter_id=1, sequence=1, text="Second sentence.", start_time=2.0, end_time=4.0),
        Sentence(sentence_id=3, chapter_id=1, sequence=2, text="Third sentence.", start_time=4.0, end_time=6.0),
        Sentence(sentence_id=4, chapter_id=2, sequence=0, text="Fourth sentence.", start_time=0.0, end_time=3.0),
        Sentence(sentence_id=5, chapter_id=2, sequence=1, text="Fifth sentence.", start_time=3.0, end_time=5.0),
    ]
